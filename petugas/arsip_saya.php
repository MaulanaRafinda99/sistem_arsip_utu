                ...
                <div class="row">
                    ...
                    <div class="col-lg-4" style="margin-top: 7px;">
                        ...
                        <div class="d-flex flex-row">
                            <a href="arsip_saya.php" class="btn btn-default" style="margin-top: -0.5px; background-color:#F6F8FA;"><i class="fa fa-undo" style="color: #000;"></i></a>
            ...
            <table id="table" class="table table-bordered table-striped table-hover table-datatable">
                ...
                <tbody>
                    ...
                    if (isset($_GET['kategori'])) {
                        ...
                        $arsip = mysqli_query($koneksi, "SELECT * FROM arsip,kategori WHERE arsip_petugas=$saya and arsip_kategori=kategori_id and arsip_kategori='$kategori' ORDER BY arsip_id DESC");
                    } else {
