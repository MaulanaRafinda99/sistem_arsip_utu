                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <ul class="breadcome-menu" style="padding-top: 0px">
                                ...
                                <li><a href="arsip_saya.php">Arsip Dihapus</a><span class="bread-blod"></span></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="panel-body">
            ...
            <table id="table" class="table table-bordered table-striped table-hover table-datatable">
                ...
                <tbody>
                    ...
                    $arsip = mysqli_query($koneksi, "SELECT * FROM arsip,kategori WHERE arsip_kategori = kategori_id AND arsip_status = 'TRASH' ORDER BY arsip_id DESC");
